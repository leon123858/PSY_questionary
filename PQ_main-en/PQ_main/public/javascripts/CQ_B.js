		...
		return new Promise((resolve) => {
			jsPsych.init({
				...
				on_trial_finish: () => {
					...
					if (
						(questionsPlusTen[questionsIndex] == '1' &&
							lastData[0].response == 'j') ||
						(questionsPlusTen[questionsIndex] == '2' &&
							lastData[0].response == 'f') ||
						(questionsPlusTen[questionsIndex] == '3' &&
							lastData[0].response == null)
					) {
						this._tmpScore++;
					}
					questionsIndex++;
